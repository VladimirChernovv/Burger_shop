...
class AddBurgerForm extends React.Component {
  ...
  createBurger = event => {
    ...
    // оздаём объект который будет принимать
    // все значения всех полей из нашей формы
    // для создания нашего бургера
    const burger = {
  ...
  render() {
    return (
      <form className="burger-edit" onSubmit={this.createBurger}>
        ...
        <select className="select" ref={this.statusRef} name="select">
